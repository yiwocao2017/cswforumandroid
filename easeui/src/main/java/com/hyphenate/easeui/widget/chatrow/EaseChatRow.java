...
//        }
        ...
        //set nickname and avatar
        if(message.direct() == Direct.SEND){
            EaseUserUtils.setUserAvatar(context, userAvatarView, EaseChatFragment.PHOTO_MY);
        }else{
            EaseUserUtils.setUserAvatar(context, userAvatarView, EaseChatFragment.PHOTO_OTHER);
            EaseUserUtils.setUserNick(message.getFrom(), usernickView);
        }
