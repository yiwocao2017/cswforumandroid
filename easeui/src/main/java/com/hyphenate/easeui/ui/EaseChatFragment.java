...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public static String PHOTO_MY;
    public static String NAME_MY;
    public static String PHOTO_OTHER;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        PHOTO_MY = fragmentArgs.getString("myPhoto");
        NAME_MY = fragmentArgs.getString("myName");
        PHOTO_OTHER = fragmentArgs.getString("otherPhoto");
    ...
    protected void setUpView() {
        ...
        titleBar.setTitle(fragmentArgs.getString("nickName"));
        titleBar.setBackgroundColor(getResources().getColor(R.color.title_red));
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            // set title
    ...
    public void onMessageReceived(List<EMMessage> messages) {
        for (EMMessage message : messages) {
            ...
            if (username.equals(toChatUsername.toLowerCase()) || message.getTo().equals(toChatUsername.toLowerCase())) {
    ...
    protected void sendTextMessage(String content) {
        if(EaseAtMessageHelper.get().containsAtUsername(content)){
            ...
            message.setAttribute("photo",PHOTO_MY);
            message.setAttribute("nickName",NAME_MY);
            sendMessage(message);
        }
    }
