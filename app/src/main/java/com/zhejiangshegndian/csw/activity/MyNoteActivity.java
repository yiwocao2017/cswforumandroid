...
public class MyNoteActivity extends MyBaseActivity implements SwipeRefreshLayout.OnRefreshListener, RefreshLayout.OnLoadListener, AdapterView.OnItemClickListener  {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        if(list.size() > 0){
            ...
            startActivity(new Intent(MyNoteActivity.this, NoteActivity.class).putExtra("code",list.get(i).getCode()));
        }
    }
    ...
    private void getNote() {
        ...
        try {
            ...
            object.put("keyword", "");
            object.put("title", "");
            object.put("publisher", userInfoSp.getString("userId", ""));
        ...
        new Xutil().post(Constants.CODE_610130, object.toString(), new Xutil.XUtils3CallBackPost() {
            ...
            public void onTip(String tip) {
                Toast.makeText(MyNoteActivity.this, tip, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onError(String error, boolean isOnCallback) {
                Toast.makeText(MyNoteActivity.this, "无法连接服务器，请检查网络", Toast.LENGTH_SHORT).show();
            }
        });
    }
